exports = async function(changeEvent) {
  try {
    const body = {
     articles: changeEvent.fullDocument.articles,
     salesOrg: changeEvent.fullDocument.salesOrg,
     storeNumber: changeEvent.fullDocument.storeNumber,
     userName: changeEvent.fullDocument.userName
    }
    console.log(JSON.stringify(body))
    const response = await context.http.post({
        url: "https://api.sallinggroup.com/v1-test/mobile-platform-services/ScrapSalesManagerArticles",
