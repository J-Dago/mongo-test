exports = async function(taskId, userName) {
  try {
    
  const response = await context.http.get({
      url: `https://api.sallinggroup.com/v1-test/mobile-platform-services/GetBBDNextCheckDates?&username=${userName}&taskId=${taskId}`,
      headers: {
