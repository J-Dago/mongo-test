exports = async function(storeNumber, username) {
  ...
  const response = await context.http.get({
      url: `https://api.sallinggroup.com/v1-test/mobile-platform-services/GetAllPrintersByStoreNumberPrinterType?storeNumber=${storeNumber}&username=${username}&printerType=`,
      headers: {
